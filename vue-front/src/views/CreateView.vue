  ...
  <div class="container mt-3">
    ...
    <form>
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="email" class="form-control" id="email" placeholder="이메일를 입력하세요." name="email" :class="{active: active.email }" v-model="result.email">
      </div>
      <div class="mb-3">
      ...
      <div class="d-flex">
        <div class="p-2 flex-fill">
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio1" name="optradio" value="1" checked v-model="result.gender">남성
            <label class="form-check-label" for="radio1"></label>
          </div>
        </div>
        <div class="p-2 flex-fill">
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio2" name="optradio" value="2" v-model="result.gender">여성

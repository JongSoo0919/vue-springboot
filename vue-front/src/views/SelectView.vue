      ...
      <div class="d-flex">
        <div class="p-2 flex-fill" v-if="result.gender">
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio1" name="optradio" v-bind:value="true" checked>남성
            <label class="form-check-label" for="radio1"></label>
          </div>
        </div>
        <div class="p-2 flex-fill" v-else>
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio2" name="optradio" v-bind:value="false">여성
